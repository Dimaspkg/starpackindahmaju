    ...
    <section className={styles.industryContainer} id="industry">
      ...
      <div className={styles.grid}>
        {t.industry.items.map((item: any, index: number) => (
          <div 
            key={index} 
            className={`${styles.card} ${index === t.industry.items.length - 1 ? styles.highlight : ''} reveal fadeUp delay${index % 5}`}
          >
      ...
      <div className={styles.footerActions}>
        <LocalizedLink href="/industries" className={styles.viewMoreBtn}>
