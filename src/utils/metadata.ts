...
const metadataTranslations: Record<string, Record<string, PageMetadata>> = {
  en: {
    home: {
      title: "UV Coating & Vacuum Metallizing Plastic Company Indonesia | PT STARPACK INDAH MAJU",
      description: "Get the best UV plastic coating & vacuum metallizing plastic coating services in Indonesia. PT Starpack Indah Maju offers premium, consistent, and ISO 9001:2015 certified plastic coating services.",
      keywords: ["Plastic Coating Services", "Vacuum Metallizing Plastic Coating Indonesia", "UV Plastic Coating", "PT Starpack Indah Maju"]
    },
    about: {
      title: "About Us - UV Coating & Vacuum Metallizing Company | PT STARPACK INDAH MAJU",
      description: "History, mission, and values of PT Starpack Indah Maju. We are ISO 9001:2015 certified UV Coating and Vacuum Metallizing specialists in Indonesia.",
      keywords: ["About Starpack", "Plastic Coating Company", "Jakarta Coating Factory", "ISO 9001:2015"]
    },
    contact: {
      title: "Contact Us - Plastic Coating Service Consultation | PT STARPACK INDAH MAJU",
      description: "Contact PT Starpack Indah Maju in Jakarta to discuss your plastic product UV coating and vacuum metallizing requirements, pricing, and specifications.",
      keywords: ["Contact Starpack", "Coating Factory Address Jakarta", "UV Plastic Coating Price", "Vacuum Metallizing Service"]
    },
    quality: {
      title: "Quality & Certification - ISO 9001:2015 Certified | PT STARPACK INDAH MAJU",
    ...
    technology: {
      title: "Advanced Plastic Coating Technology & Machinery | PT STARPACK INDAH MAJU",
    ...
    "uv-coating": {
      title: "Advanced UV Coating Technology for Plastics | PT STARPACK INDAH MAJU",
    ...
    "vacuum-metallizing": {
      title: "Premium Vacuum Metallizing Plastic Plating | PT STARPACK INDAH MAJU",
    ...
    industries: {
      title: "Industries Served - Custom Plastic Coating Solutions | PT STARPACK INDAH MAJU",
    ...
    "beauty-cosmetics": {
      title: "Cosmetic & Beauty Packaging UV Coating | PT STARPACK INDAH MAJU",
    ...
    electronics: {
      title: "Consumer Electronics Plastic Coating Services | PT STARPACK INDAH MAJU",
    ...
    fashion: {
      title: "Fashion Products Aesthetic Plastic Coating | PT STARPACK INDAH MAJU",
    ...
    "fashion-accessories": {
      title: "Fashion Accessories Decorative Plating | PT STARPACK INDAH MAJU",
    ...
    accessories: {
      title: "Premium Accessories Plastic Coating & Plating | PT STARPACK INDAH MAJU",
    ...
    "home-lifestyle": {
      title: "Home & Lifestyle Products Durable Coating | PT STARPACK INDAH MAJU",
    ...
    automotive: {
      title: "Automotive Interior & Exterior Plastic Coating | PT STARPACK INDAH MAJU",
    ...
    footwear: {
      title: "Footwear Accessories Plastic Coating & Plating | PT STARPACK INDAH MAJU",
    ...
    "many-more": {
      title: "Diverse Industrial Plastic Coating Services | PT STARPACK INDAH MAJU",
    ...
    insights: {
      title: "Company Insights & News - UV Coating Industry | PT STARPACK INDAH MAJU",
    ...
    sitemap: {
      title: "Sitemap - PT STARPACK INDAH MAJU",
      description: "Find and navigate through all pages, industries, technologies, and services of PT Starpack Indah Maju.",
      keywords: ["Starpack Sitemap", "Website Map", "Starpack Pages Navigation"]
    }
  },
  id: {
    home: {
      title: "Perusahaan UV Coating & Vacuum Metallizing Plastik Indonesia | PT STARPACK INDAH MAJU",
      description: "Dapatkan jasa UV plastic coating & vacuum metallizing plastic coating terbaik di Indonesia. PT Starpack Indah Maju menawarkan coating plastic service premium, konsisten, dan bersertifikasi ISO 9001:2015.",
      keywords: ["Jasa plastik Coating", "Vacuum Metallizing Plastic Coating Indonesia", "UV Plastic Coating", "PT Starpack Indah Maju"]
    },
    about: {
    ...
    quality: {
      title: "Kualitas & Sertifikasi - Terakreditasi ISO 9001:2015 | PT STARPACK INDAH MAJU",
    ...
    technology: {
      title: "Teknologi & Mesin Coating Plastik Canggih | PT STARPACK INDAH MAJU",
    ...
    "uv-coating": {
      title: "Teknologi UV Coating Plastik Terdepan | PT STARPACK INDAH MAJU",
    ...
    "vacuum-metallizing": {
      title: "Jasa Vacuum Metallizing & Chrome Plastik Premium | PT STARPACK INDAH MAJU",
    ...
    industries: {
      title: "Bidang Industri - Solusi Kustom Coating Plastik | PT STARPACK INDAH MAJU",
    ...
    "beauty-cosmetics": {
      title: "Coating Kemasan Kosmetik & Kecantikan Premium | PT STARPACK INDAH MAJU",
    ...
    electronics: {
      title: "Jasa Coating Plastik Elektronik Konsumen | PT STARPACK INDAH MAJU",
    ...
    fashion: {
      title: "Coating Plastik Estetis Produk Fashion | PT STARPACK INDAH MAJU",
    ...
    "fashion-accessories": {
      title: "Plating Dekoratif Aksesoris Fashion | PT STARPACK INDAH MAJU",
    ...
    accessories: {
      title: "Jasa Coating & Plating Aksesoris Premium | PT STARPACK INDAH MAJU",
    ...
    "home-lifestyle": {
      title: "Coating Tahan Lama Produk Rumah Tangga & Gaya Hidup | PT STARPACK INDAH MAJU",
    ...
    automotive: {
      title: "Coating Plastik Otomotif Interior & Eksterior | PT STARPACK INDAH MAJU",
    ...
    footwear: {
      title: "Coating & Plating Plastik Aksesoris Sepatu/Alas Kaki | PT STARPACK INDAH MAJU",
    ...
    "many-more": {
      title: "Layanan Coating Plastik Berbagai Sektor Industri | PT STARPACK INDAH MAJU",
    ...
    insights: {
      title: "Wawasan & Berita Perusahaan - Industri UV Coating | PT STARPACK INDAH MAJU",
    ...
    sitemap: {
      title: "Peta Situs (Sitemap) - PT STARPACK INDAH MAJU",
      description: "Temukan dan jelajahi seluruh halaman, industri, teknologi, dan layanan dari PT Starpack Indah Maju.",
      keywords: ["Sitemap Starpack", "Peta Navigasi Situs", "Navigasi Halaman Starpack"]
    }
  },
  zh: {
    home: {
      title: "印尼塑料UV喷涂与真空电镀加工厂 | PT STARPACK INDAH MAJU",
      description: "获取印尼最优质的塑料UV喷涂与真空电镀服务。PT Starpack Indah Maju提供优质、一致且通过ISO 9001:2015认证的塑料表面涂装加工服务。",
      keywords: ["塑料涂装服务", "印尼真空电镀加工", "塑料UV喷涂", "PT Starpack Indah Maju"]
    },
    about: {
      title: "关于我们 - 塑料UV喷涂与真空电镀公司 | PT STARPACK INDAH MAJU",
      description: "PT Starpack Indah Maju的发展历程、企业使命和价值观。我们是印尼通过ISO 9001:2015认证的专业塑料UV喷涂与真空电镀加工服务商。",
      keywords: ["关于Starpack", "塑料涂装公司", "雅加达喷涂厂", "ISO 9001:2015认证"]
    },
    contact: {
      title: "联系我们 - 塑料涂装及电镀技术咨询 | PT STARPACK INDAH MAJU",
      description: "联系位于雅加达的PT Starpack Indah Maju专家团队，共同商讨您的塑料制品UV喷涂与真空电镀的产品规格、价格及定制要求。",
      keywords: ["联系Starpack", "雅加达涂装厂地址", "UV塑料喷涂价格", "真空电镀服务"]
    },
    quality: {
      title: "品质与认证 - ISO 9001:2015国际标准 | PT STARPACK INDAH MAJU",
      description: "了解我们严格的品质控制流程以及针对高端UV喷涂与真空电镀所取得的ISO 9001:2015国际质量管理体系认证。",
      keywords: ["Starpack品质认证", "ISO 9001:2015涂装", "塑料质量检测", "雅加达高标准制造"]
    },
    technology: {
      title: "先进塑料表面涂装技术与专业设备 | PT STARPACK INDAH MAJU",
      description: "探索我们位于印尼的现代化制造工厂，配备先进的自动化UV喷涂生产线以及工业级真空电镀镀膜舱。",
      keywords: ["涂装工艺技术", "雅加达真空镀膜舱", "UV光固化机", "塑料表面处理设备"]
    },
    "uv-coating": {
      title: "先进塑料UV喷涂及光固化表面处理 | PT STARPACK INDAH MAJU",
      description: "创新的塑料UV涂装服务，提供高光、哑光、亲肤触感（Soft Touch）及各种特殊效果的表面工艺与瞬间UV固化。",
      keywords: ["塑料UV喷涂", "亲肤触感涂层", "涂装表面效果", "哑光UV喷涂"]
    },
    "vacuum-metallizing": {
      title: "优质真空电镀与塑料表面金属化 | PT STARPACK INDAH MAJU",
      description: "印尼专业的工业级真空电镀服务。为您提供塑料制品的镜面铬（Chrome）、金属金以及丰富多彩的金属色电镀层。",
      keywords: ["真空电镀", "塑料镀铬加工", "高反光金属涂层", "真空镀膜服务"]
    },
    industries: {
      title: "服务行业 - 定制塑料表面处理解决方案 | PT STARPACK INDAH MAJU",
      description: "为化妆品包装、汽车内外饰件、消费电子、家居生活及服饰配饰提供定制化塑料涂装与电镀处理服务。",
      keywords: ["化妆品包装涂装", "汽车塑料件电镀", "电子塑料表面处理", "配饰金属化加工"]
    },
    "beauty-cosmetics": {
      title: "化妆品及美容包材高端UV喷涂与电镀 | PT STARPACK INDAH MAJU",
      description: "为口红管、睫毛膏盖、面霜瓶及粉盒等提供高级UV喷涂与真空电镀工艺，全面提升您的化妆品品牌溢价。",
      keywords: ["化妆品瓶涂装", "口红管盖电镀", "美容产品表面处理", "高端美妆包装"]
    },
    electronics: {
      title: "消费电子塑料外壳涂装与电镀加工 | PT STARPACK INDAH MAJU",
      description: "为消费电子产品、家用电器外壳及定制配件提供耐磨、防刮且美观的UV喷涂与真空金属化电镀保护层。",
      keywords: ["电子配件喷涂", "家电塑料表面处理", "保护性UV涂层", "电子外壳真空电镀"]
    },
    fashion: {
      title: "时尚潮流产品美学塑料涂装服务 | PT STARPACK INDAH MAJU",
      description: "迷人的镜面铬、高光及定制多色涂装，为各类潮流单品、时尚配件以及零售展示道具增添高端美学价值。",
      keywords: ["时尚单品电镀", "高光时尚表面", "美学塑料涂装", "创意彩色喷涂"]
    },
    "fashion-accessories": {
      title: "时尚配饰及箱包鞋材装饰性电镀 | PT STARPACK INDAH MAJU",
      description: "为包扣、鞋材配件、钮扣及各类定制时尚饰品提供高精度装饰性金属电镀与耐磨UV保护层处理。",
      keywords: ["鞋材配件电镀", "箱包配件喷涂", "装饰性饰品涂装", "金属质感塑料"]
    },
    accessories: {
      title: "高端配饰塑料涂装与高精度电镀 | PT STARPACK INDAH MAJU",
      description: "为多种塑料配饰部件、日用品构件以及定制产品元素提供高精度装饰性电镀与表面涂装解决方案。",
      keywords: ["塑料配饰电镀", "定制配件涂装", "装饰性塑料加工", "Starpack配饰服务"]
    },
    "home-lifestyle": {
      title: "家居及生活用品耐用性塑料表面处理 | PT STARPACK INDAH MAJU",
      description: "为家居装饰品、高端餐具、家具塑料件及生活方式用品提供具备高防护性和极佳视觉美感的UV喷涂与真空电镀服务。",
      keywords: ["家居装饰涂装", "家具塑料表面处理", "耐用餐具喷涂", "生活用品电镀加工"]
    },
    automotive: {
      title: "汽车内饰与外观塑料件高规格喷涂 | PT STARPACK INDAH MAJU",
      description: "为汽车塑料格栅、内饰饰条及各类汽车塑件提供耐候、抗刮擦且高精度的高规格UV喷涂与真空电镀加工。",
      keywords: ["汽车塑料内饰", "汽车中控饰条喷涂", "抗刮擦塑料电镀", "汽车塑件金属化"]
    },
    footwear: {
      title: "鞋类塑料配件及鞋跟高光电镀与涂装 | PT STARPACK INDAH MAJU",
      description: "为鞋跟（Heels）、鞋扣及各类鞋类装饰件提供高附着力的电镀与真空表面处理，确保美观与卓越的耐用度。",
      keywords: ["鞋跟电镀加工", "鞋扣装饰性涂装", "鞋类配件表面处理", "Starpack鞋材"]
    },
    "many-more": {
      title: "多领域工业及消费塑料表面处理 | PT STARPACK INDAH MAJU",
      description: "为儿童玩具、医疗器械塑料外壳、创意促销礼品等更多领域的塑料制品提供专业的定制喷涂与电镀加工。",
      keywords: ["玩具塑料喷涂", "医疗外壳表面处理", "定制工业电镀", "雅加达专业塑件涂装"]
    },
    insights: {
      title: "行业资讯与企业动态 - 塑料涂装前沿 | PT STARPACK INDAH MAJU",
      description: "密切关注塑料喷涂与真空电镀领域的最新行业新闻、技术升级、质量标准及最新的表面效果设计趋势。",
      keywords: ["Starpack动态", "塑料涂装趋势", "真空电镀文章", "质量标准更新"]
    },
    sitemap: {
      title: "网站地图 (Sitemap) - PT STARPACK INDAH MAJU",
      description: "快速查找并浏览 PT Starpack Indah Maju 的所有网页、所服务行业、核心技术及表面加工效果。",
      keywords: ["Starpack网站地图", "页面指南", "网站导航"]
    }
  },
  jp: {
    home: {
      title: "インドネシアのプラスチックUVコーティング＆真空蒸着加工メーカー | PT STARPACK INDAH MAJU",
      description: "インドネシアで最高のプラスチックUVコーティングおよび真空蒸着サービスを提供します。PT Starpack Indah Majuは、プレミアムで一貫した、ISO 9001:2015認証のプラスチックコーティングサービスを提供します。",
      keywords: ["プラスチックコーティングサービス", "インドネシア真空蒸着加工", "プラスチックUV塗装", "PT Starpack Indah Maju"]
    },
    about: {
      title: "会社概要 - UVコーティング＆真空蒸着メーカー | PT STARPACK INDAH MAJU",
      description: "PT Starpack Indah Majuの沿革、使命、価値観。インドネシアでISO 9001:2015認証を取得したUVコーティングおよび真空蒸着のスペシャリストです。",
      keywords: ["Starpackについて", "プラスチックコーティング企業", "ジャカルタ塗装工場", "ISO 9001:2015認証"]
    },
    contact: {
      title: "お問い合わせ - プラスチック塗装・蒸着の仕様相談 | PT STARPACK INDAH MAJU",
      description: "プラスチック製品のUV塗装や真空蒸着の価格、仕様、ご要望について、ジャカルタのPT Starpack Indah Majuの専門チームへお気軽にご相談ください。",
      keywords: ["Starpack連絡先", "ジャカルタ工場住所", "UV塗装価格", "真空蒸着サービス"]
    },
    quality: {
      title: "品質と認証 - ISO 9001:2015国際規格取得 | PT STARPACK INDAH MAJU",
    ...
    technology: {
      title: "先進プラスチックコーティング技術と最先端設備 | PT STARPACK INDAH MAJU",
    ...
    "uv-coating": {
      title: "高度なプラスチックUVコーティングと表面保護 | PT STARPACK INDAH MAJU",
    ...
    "vacuum-metallizing": {
      title: "高品質真空蒸着とプラスチック鏡面メッキ | PT STARPACK INDAH MAJU",
    ...
    industries: {
      title: "提供業界 - カスタムプラスチックコーティング解決策 | PT STARPACK INDAH MAJU",
    ...
    "beauty-cosmetics": {
      title: "高級化粧品・美容容器向けUVコーティング＆蒸着 | PT STARPACK INDAH MAJU",
    ...
    electronics: {
      title: "家電・電子機器プラスチック外装のコーティング塗装 | PT STARPACK INDAH MAJU",
    ...
    fashion: {
      title: "ファッション製品向け意匠性プラスチックコーティング | PT STARPACK INDAH MAJU",
    ...
    "home-lifestyle": {
      title: "生活雑貨・インテリア用品向け耐久性プラスチックコーティング | PT STARPACK INDAH MAJU",
    ...
    automotive: {
      title: "自動車内装・外装用プラスチック部品の耐候塗装 | PT STARPACK INDAH MAJU",
    ...
    footwear: {
      title: "フットウェア靴材・ヒール・バックルの装飾メッキと塗装 | PT STARPACK INDAH MAJU",
    ...
    "many-more": {
      title: "多様な産業・玩具・玩具向けプラスチックコーティング | PT STARPACK INDAH MAJU",
    ...
    insights: {
      title: "インサイトと企業活動ニュース - コーティング業界動向 | PT STARPACK INDAH MAJU",
      description: "プラスチック塗装および真空蒸着業界における最新ニュース、技術進歩、品質規格、最新デザインのトレンドについて発信します。",
      keywords: ["Starpackニュース", "プラスチック塗装トレンド", "真空蒸着技術記事", "品質管理更新"]
    },
    sitemap: {
      title: "サイトマップ (Sitemap) - PT STARPACK INDAH MAJU",
      description: "PT Starpack Indah Maju のすべてのWebページ、提供業界、保有技術、および仕上がり効果を一覧から探せます。",
