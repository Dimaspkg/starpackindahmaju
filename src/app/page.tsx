      ...
      <div className="pageContainer">
        ...
        <section className={styles.section} id="about">
          ...
          <div className={styles.aboutOverhaulHeader}>
            ...
            <Link href="/about" className={styles.aboutPremiumLink}>
        ...
        <section className={styles.section} id="technology">
          <div className={styles.sectionHeader}>
            ...
            <Link href="/technology" className={styles.viewAllBtn}>
              {l.techViewAll} <Arrow />
            </Link>
          </div>
        ...
        <section className={styles.section} id="industry">
          <div className={styles.sectionHeader}>
            ...
            <Link href="/industries" className={styles.viewAllBtn}>
          ...
          <div className={styles.industriesGrid}>
            {t.industry?.items?.slice(0, 6).map((item: any, i: number) => (
              <Link key={i} href="/industries" className={styles.industryCard}>
                <Image
                  src={item.image}
                  alt={item.title}
                  fill
        ...
        <section className={styles.section} id="quality">
          <div className={styles.sectionHeader}>
            ...
            <Link href="/quality-certification" className={styles.viewAllBtn}>
          ...
          {latestPosts.length > 0 ? (
            <div className={styles.insightsGrid}>
              {latestPosts.map((post: any, i: number) => (
                <Link key={i} href={`/insights/${post.slug}`} className={styles.insightCard}>
