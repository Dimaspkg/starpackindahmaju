    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: language === 'id' ? 'Fashion' : language === 'jp' ? 'ファッション' : language === 'zh' ? '时尚' : 'Fashion', href: '/industries/fashion' },
          { label: language === 'id' ? 'Aksesoris' : language === 'jp' ? 'アクセサリー' : language === 'zh' ? '配饰' : 'Accessories', href: '/industries/accecories' },
              ...
              <ul className={styles.linkList}>
                {section.links.map((link, lidx) => (
                  <li key={lidx} className={styles.linkItem}>
                    <LocalizedLink href={link.href} className={styles.link}>
                      {link.label}
                    </LocalizedLink>
                  </li>
                ))}
